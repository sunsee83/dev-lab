...
import { addAction, createSection, renderEmpty } from './ri-primitives.js';
import { renderRiSettings } from './ri-settings.js';
...
export function mountRiPanel({
  ...
  function renderSettings(body) {
    return renderRiSettings({ body, settings, settingsState, capabilities, doc });
  }
